...
################################################################### Huzaifa ###################################################    
    ...
    def show_loading_screen(self):
        ...
        self.logo_image = Image.open("RIEE.jpg")  # Ensure this path is correct
        ...
        # Schedule messages
        self.message_label = tk.Label(self.root, font=("Helvetica", 16), bg="white")
        self.message_label.pack(pady=(20, 0))  # Add some padding above the message

        # Display first message after 200 milliseconds
        self.root.after(200, self.display_first_message)

        # Schedule the loading screen to close and the main interface to open after 5000 milliseconds (5 seconds)
        self.root.after(5000, self.setup_main_interface)

    def display_first_message(self):
        self.message_label.config(text="Welcome to Roborace")
        # Schedule second message to appear 500 milliseconds after the first
        self.root.after(2500, self.display_second_message)

    def display_second_message(self):
        self.message_label.config(text="Organised by RIE with the courtesy of KCL Tech and AI institute.")
        self.root.after(2500, self.display_third_message)
    
    def display_third_message(self):
        self.message_label.config(text="Have Fun and don't BURN our Robots ;)")
    ...
    def setup_main_interface(self):
        ...
        self.timer_label = tk.Label(self.button_frame, text="Timer: 0m 0ss", font=("Helvetica", 24))
